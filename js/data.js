...
const portfolioProjects = [
  {
    ...
    title: "14th Church Thanksgiving Celebration Backdrop",
    clientName: "Bible Baptist Church, Hindangon",
    year: "2025–2026",
  ...
  },
  {
    ...
    category: "church",
    categoryLabel: "Church & Ministry",
    title: "Youth Fellowship 2026 Conference Key Art",
    clientName: "Youth Fellowship Ministry",
    year: "2026",
  ...
  {
    id: "pastor-leo-tribute",
    category: "church",
    categoryLabel: "Church & Ministry",
    title: "Pastor Leo 60th Birthday Tribute Slideshow",
    clientName: "Community Assembly Church",
    year: "2025",
  ...
  },
  {
    ...
    title: "Joyce May @ 18 — Debut Design & Photography Suite",
  ...
  },
  {
    ...
    category: "events",
    categoryLabel: "Event Design",
    title: "Emmanuel 21st Birthday Milestone Design Package",
    clientName: "Private Client",
    year: "2025",
  ...
  {
    id: "elgreensyde-brochure",
    category: "brochures",
    categoryLabel: "Brochures & Print",
    title: "Elgreensyde Microgreens — Product Tri-Fold Brochure",
    clientName: "Elgreensyde Farms",
    year: "2025",
    ...
    details: {
      ...
      solution: "Used natural green tones, custom iconography, and generous whitespace to create a welcoming, informative layout.",
      tools: ["Adobe InDesign", "Illustrator"]
    }
  },
  {
    id: "nutriform-brochure",
    category: "brochures",
    categoryLabel: "Brochures & Print",
    title: "Nutriform X — Health & Wellness Product Booklet",
    clientName: "Nutriform Corp",
    year: "2025",
  ...
  },
  {
    ...
    category: "brochures",
    categoryLabel: "Brochures & Print",
    title: "CMU OJT - CULMINATION PROGRAM BROCHURE",
    ...
    details: {
      ...
      solution: "Employed grid-based layouts, school branding guidelines, and strategic highlighting of key deadlines.",
      tools: ["Adobe InDesign"]
    }
  },
  {
    id: "undergrad-seminar-2025",
    category: "academic",
    categoryLabel: "Academic",
    title: "Undergraduate Seminar 2025 — Official Program Brochure",
    clientName: "Central Mindanao University",
    year: "2025",
    ...
    details: {
      ...
      solution: "Created a formal serif typography system paired with a minimalist geometric cover design.",
  ...
  },
  {
    ...
    category: "academic",
    categoryLabel: "Academic",
    title: "Art Nouveau & Mixed Media — College Design Projects",
    clientName: "College Fine Art & Design",
    year: "2024",
...
const servicePackages = [
  {
    icon: "🎓",
    title: "Academic Org Media",
    subtitle: "School Projects & University Org Branding",
    description: "High-impact academic pubmats, official organization banners, event programs, and creative art history project designs.",
    deliverables: [
      "PSABE-PPG CMU Official Banners & Congratulations Pubmats",
      "Academic Seminar Booklets & Program Brochures",
      "Fine Art & Vector Illustration History Projects"
    ]
  },
  {
    icon: "⛪",
  ...
  },
  {
    ...
    subtitle: "Story-Driven Editing & Motion Graphics",
    description: "Turn event footage, photoshoot highlights, and church recaps into engaging videos with crisp sound design and color grading.",
    deliverables: [
      "Event Recap Aftermovies (1080p/4K)",
      "Birthday & Debut Photo/Video Slideshows",
      "High-Quality AI-Generated Intro & Outro Motion Animations"
    ]
  },
  {
    icon: "📄",
    title: "Corporate Print & Brochure Layouts",
    subtitle: "High-Impact Commercial Collateral",
    description: "Sleek tri-fold brochures (Canva), product booklets, and marketing materials engineered for commercial printing and PDF distribution.",
    deliverables: [
      "Tri-fold & Bi-fold Product Brochures (Canva)",
      "Multi-Page Booklets & Catalogues",
      "Certificates of Appreciation & Awards",
      "Print-Ready CMYK Files with Bleed Specs"
    ]
  }
];
...
const workflowSteps = [
  {
    ...
    desc: "I'll discuss your vision, target audience, event dimensions, color themes, and deliverables deadline."
  },
  {
    number: "02",
    title: "Concept & Layout Draft",
    desc: "I create preliminary visual concepts, color keys, and video storyboards for your review and feedback."
  },
  {
    number: "03",
    title: "Refinement & Details",
    desc: "Polishing typography, high-res photo retouching, motion transitions, and fine-tuning exact dimensions."
  },
  {
    number: "04",
    title: "Final Export & Delivery",
    desc: "Receiving print-ready 300DPI PDF/CMYK files, high-bitrate MP4 videos, and editable source assets."
  }
];
